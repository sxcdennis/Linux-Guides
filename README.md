...
- [User & Group Management](https://github.com/sxcdennis/Linux-Guides/blob/master/usergroup.md  "User & Group Management")

- [grep and find](https://github.com/sxcdennis/Linux-Guides/blob/master/grepfind.md "grep and find")

- [sed and awk](https://github.com/sxcdennis/Linux-Guides/blob/master/sedawk.md "sed and awk")

- [tar](https://github.com/sxcdennis/Linux-Guides/blob/master/tar.md "tar")

- [Permissions: chmod, chown, chgrp & ACL](https://github.com/sxcdennis/Linux-Guides/blob/master/chmodacl.md "Permissions: chmod, chgrp & setfacl")

- [Cron Jobs](https://github.com/sxcdennis/Linux-Guides/blob/master/cronjobs.md "Cron Jobs")

- [Reset Root Password](https://github.com/sxcdennis/Linux-Guides/blob/master/resetroot.md "Reset Root Password")

- [systemctl](https://github.com/sxcdennis/Linux-Guides/blob/master/systemctl.md "systemctl")

- [firewall](https://github.com/sxcdennis/Linux-Guides/blob/master/firewall.md "firewall")
...
- [Creating and Updating yum repositories (including updating kernels)](https://github.com/sxcdennis/Linux-Guides/blob/master/yum.md "Creating and Updating yum repositories including updating kernels")
